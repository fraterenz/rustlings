...
pub fn capitalize_first(input: &str) -> String {
    ...
    match c.next() {
        None => String::new(),
        // to_uppercase returns an iterator by consuming self, taking ownership
...
mod tests {
    ...
    fn test_iterate_into_string() {
        let words = vec!["hello", " ", "world"];
        // using deref coercion in the closure, see Step2 test 
        // capitalize_first(&x) where we explicited the reference
