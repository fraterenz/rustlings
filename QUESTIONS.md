Issues on `move_semantics3.rs` see [first issue](https://github.com/rust-lang/rustlings/issues/631) and [my issue](https://github.com/rust-lang/rustlings/issues/632).
